...
import { CityUpsertWithoutComplexesInput } from './city-upsert-without-complexes.input';
import { CityWhereUniqueInput } from './city-where-unique.input';
import { CityUpdateWithoutComplexesInput } from './city-update-without-complexes.input';

@InputType()
export class CityUpdateOneRequiredWithoutComplexesNestedInput {
    ...
    @Field(() => CityUpsertWithoutComplexesInput, {nullable:true})
    @Type(() => CityUpsertWithoutComplexesInput)
    ...
    @Field(() => CityUpdateWithoutComplexesInput, {nullable:true})
