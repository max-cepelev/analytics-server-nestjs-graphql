...
import { BuildingUncheckedUpdateManyWithoutComplexNestedInput } from '../building/building-unchecked-update-many-without-complex-nested.input';
import { DateTimeFieldUpdateOperationsInput } from '../prisma/date-time-field-update-operations.input';

@InputType()
export class ComplexUncheckedUpdateWithoutDistrictInput {
    ...
    @Field(() => BuildingUncheckedUpdateManyWithoutComplexNestedInput, {nullable:true})
