...
import { CityUpdateOneRequiredWithoutBuildingsNestedInput } from '../city/city-update-one-required-without-buildings-nested.input';
...
@InputType()
export class BuildingUpdateWithoutPropertiesInput {
    ...
    @Field(() => CityUpdateOneRequiredWithoutBuildingsNestedInput, {nullable:true})
