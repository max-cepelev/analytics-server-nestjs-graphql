...
import { BuildingUpdateManyWithoutDeveloperNestedInput } from '../building/building-update-many-without-developer-nested.input';
import { DateTimeFieldUpdateOperationsInput } from '../prisma/date-time-field-update-operations.input';

@InputType()
export class DeveloperUpdateWithoutGroupInput {
    ...
    @Field(() => BuildingUpdateManyWithoutDeveloperNestedInput, {nullable:true})
