...
import { NestedEnumDecorTypeNullableWithAggregatesFilter } from './nested-enum-decor-type-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumDecorTypeNullableFilter } from './nested-enum-decor-type-nullable-filter.input';

@InputType()
export class EnumDecorTypeNullableWithAggregatesFilter {
