...
import { GroupWhereInput } from '../group/group-where.input';
import { Type } from 'class-transformer';
import { GroupOrderByWithRelationInput } from '../group/group-order-by-with-relation.input';
import { GroupWhereUniqueInput } from '../group/group-where-unique.input';
import { Int } from '@nestjs/graphql';
import { GroupScalarFieldEnum } from '../group/group-scalar-field.enum';
